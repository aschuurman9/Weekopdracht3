...
public class Kermis {
	...
	void verwerkenKeuze(String invoer) {
		switch (invoer) {
		case "1":
			botsauto.draaien();
			break;
		case "2":
			if (spin.geefAantalVerkochteKaartjesAttractie() == 0) {
				...
				spin.draaien();
			} else if (spin.geefAantalVerkochteKaartjesAttractie() != 0
					&& spin.geefAantalVerkochteKaartjesAttractie() % spin.draailimiet == 0) {
...
//			inspecteur.belastingInnen(inspecteur.checkenGokAttractie(kermisAttracties));
	...
	void aantalVerkochteKaartjesTonen(String invoer) {
		switch (invoer) {
		case "1":
			System.out.println(botsauto.naamAttractie + "\taantal kaartjes: " + botsauto.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "2":
			System.out.println(spin.naamAttractie + "\taantal kaartjes: " + spin.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "3":
			System.out.println(
					spiegelpaleis.naamAttractie + "\taantal kaartjes: " + spiegelpaleis.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "4":
			System.out
					.println(spookhuis.naamAttractie + "\taantal kaartjes: " + spookhuis.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "5":
			System.out.println(hawaii.naamAttractie + "\taantal kaartjes :" + hawaii.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "6":
			System.out.println(
					ladderklimmen.naamAttractie + "\taantal kaartjes: " + ladderklimmen.geefAantalVerkochteKaartjesAttractie() + "\n");
			break;
		case "t":
			System.out
